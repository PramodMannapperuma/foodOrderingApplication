...
class NutrientData {
  ...
  NutrientData({required this.calories, required this.kilojules, required carbohydrates, required proteins,});
  ...
  factory NutrientData.fromJson(Map<String, dynamic> json) {
    return NutrientData(
      ...
      carbohydrates: json['Carbohydrates']['Amount'],
      proteins: json['Protein']['Amount'],
    );
  }
}
...
//   final int displayType;
//
//   Proteins ({required this.energyInterval, required this.displayType});
//
//   factory Proteins.fromJson(Map<String, dynamic> json) {
//     return Proteins(
//       energyInterval: EnergyInterval.fromJson(json['Amount']['Interval']),
//       displayType: json['Amount']['Weight'],
//     );
//   }
// }
//
...
//   final int displayType;
//
//   Carbohydrates ({required this.energyInterval, required this.displayType});
//
